...
from util.config import WEST_AFRICAN_COUNTRIES, INDICATORS, START_YEAR, END_YEAR, INDICATOR_COLUMN_NAMES, json_folder
...
def extract_world_bank_data(countries: list, indicators: dict, start_year: int, end_year: int,):
    """
...
def transform_to_dataframe(indicator_mapping: dict, column_rename_map: dict) -> pd.DataFrame:
    """
    ...
    df_wide.rename(columns=INDICATOR_COLUMN_NAMES, inplace=True)
