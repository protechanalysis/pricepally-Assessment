...
indicators = [
    ...
    "SN.ITK.DEFC.ZS", "SN.ITK.DEFC.NUM", "SN.ITK.SVFI.ZS", "SN.ITK.SVFI",
...
def fetch_indicator(indicator, countries, start=2010, end=2023):
    ...
    for country in countries:
        url = f"http://api.worldbank.org/v2/country/{country}/indicator/{indicator}?format=json&date={start}:{end}&per_page=2000"
...
# Step 7: Save output
pivot_df.to_csv("africa_food_agriculture_indicators.csv", index=False)

print("✅ Data extraction complete! Saved africa_food_agriculture_indicators.csv")
print(pivot_df.head())
